...
var logger = log4js.getLogger('washswat-engine:config');
var configQuery = {
    auth: undefined,
    body: {},
    headers: {},
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if ((packageJson === null || packageJson === void 0 ? void 0 : packageJson.name) && (packageJson === null || packageJson === void 0 ? void 0 : packageJson.version)) {
                        localAppConfig.name = packageJson.name;
                        localAppConfig.version = packageJson.version;
                    }
                    logger.debug("LocalAppConfig: ".concat(JSON.stringify(localAppConfig)));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, { status: true, message: 'success', data: localPlatformConfig.data[0] }];
            }
        });
    });
}
