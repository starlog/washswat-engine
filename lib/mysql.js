                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, pool.query('SELECT 1+1 as solution')];
                            case 1:
                                result = _a.sent();
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                data = void 0;
                                if (!_connectionConfig.useCache) return [3 /*break*/, 2];
                                ...
                                if (!data) {
                                    ...
                                    pool.getConnection(function (error, connection) {
                                        if (error) {
                                            ...
                                            connection.query(queryString, function (error2, result) {
                                                connection.release();
                                                if (error2) {
                                                    reject(error2);
                                                }
