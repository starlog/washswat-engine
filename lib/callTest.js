...
var http = __importStar(require("@src/httpclient"));
var mongo = __importStar(require("@src/mongodb"));
var util2 = __importStar(require("@src/util2"));
var api = __importStar(require("@src/api"));
var config = __importStar(require("@src/config"));
var mysql = __importStar(require("@src/mysql"));
...
function doApiTest() {
    return __awaiter(this, void 0, void 0, function () {
        var result, result2, result3, ex_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                    return [4 /*yield*/, config.configure('test', 'test', null, 'debug')];
                case 1:
                    _a.sent();
