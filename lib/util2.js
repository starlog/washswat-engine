...
exports.debugDump = exports.genHashKey = exports.stringifyWithoutCircular = exports.stringify2 = exports.stringify = exports.error = exports.info = exports.debug = exports.setLogLevel = exports.getLogger = exports.configData = void 0;
...
log4js.configure(exports.configData);
var logger = log4js.getLogger('washswat-engine:util2');
var logList = [];
function findMyLogger(name) {
    for (var _i = 0, logList_1 = logList; _i < logList_1.length; _i++) {
...
function getLogger(name) {
    var myLogger = findMyLogger(name);
    if (!myLogger) {
        var myLoggerLocal = _.cloneDeep(log4js.getLogger(name));
...
function setLogLevel(logName, level) {
    if (logName !== 'all') {
        var myLogger = findMyLogger(logName);
        myLogger.level = level;
    }
    else {
        logList.forEach(function (x) {
