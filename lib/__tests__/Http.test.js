...
var expectedResultCode = [200, 550, 403];
test('Http call', function () { return __awaiter(void 0, void 0, void 0, function () {
    var data;
...
test('Http status call', function () { return __awaiter(void 0, void 0, void 0, function () {
    var data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, http.callWithComStatus(queryObject, expectedResultCode)];
            case 1:
                data = _a.sent();
                expect(data).toBeDefined();
                return [2 /*return*/];
